module.exports = (async function () {
  ...
  const url =
    "https://infra.datos.gob.ar/catalog/sspm/dataset/90/distribution/90.1/download/agregados-monetarios.csv";
  const payload = await parsers.datosGobarCSV(0, 28, url);

  const post = {
    kpi,
    t: "Depositos Privados en USD",
    st: "",
