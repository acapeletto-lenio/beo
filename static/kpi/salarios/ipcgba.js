module.exports = (async function () {
  ...
  const kpi = "ipcgba";
  const url =
    "https://infra.datos.gob.ar/catalog/sspm/dataset/101/distribution/101.1/download/indice-precios-al-consumidor-apertura-por-capitulos-base-diembre-2016-mensual.csv";
